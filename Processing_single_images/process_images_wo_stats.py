...
input_dir = '/scratch/gpfs/ksuh/STACK/'
output_dir = '/scratch/gpfs/ksuh/STACK_R/'

# Path to working directory (where weights/stats are saved):
working_dir = '/home/ksuh/JulieVision8bitCrop/Nikon20x/'

# Weights file name:
weights_file = 'mdck_20x_dapi.h5'
